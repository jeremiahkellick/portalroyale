...
class MedKitRenderer extends Renderer {
  ...
  draw(ctx, offset) {
    ...
    this.drawRectangle(ctx, transform, offset, x-16, y-14, 1, 32, 28, '#ffffff', false);
    this.drawRectangle(ctx, transform, offset, x-12, y-4, 1, 24, 8, '#000000', true);
    this.drawRectangle(ctx, transform, offset, x-4, y-12, 1, 8, 24, '#000000', true);
  }
